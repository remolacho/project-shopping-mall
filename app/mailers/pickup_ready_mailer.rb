class PickupReadyMailer < ApplicationMailer
  def customer(order:)
    ...
    mail(to: @email_to, subject: '¡Tu pedido está listo para retiro!'.freeze)
  rescue StandardError => e
    @has_error = true
    @message = e.to_s
    mail(to: ENV['EMAIL_TO'], subject: 'Error email pickup'.freeze)
  end
